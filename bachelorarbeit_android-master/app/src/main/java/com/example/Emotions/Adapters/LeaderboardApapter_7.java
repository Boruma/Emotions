...
public class LeaderboardApapter_7 extends RecyclerView.Adapter<LeaderboardApapter_7.MyViewHolderLeaderboard>{
    ...
    public static class MyViewHolderLeaderboard extends RecyclerView.ViewHolder {
        ...
        public void bindData(final User user, final Context context) {
            ...
            pointsTextView.setText(String.valueOf(user.getPoints_7()));
        }


    }

    public LeaderboardApapter_7(List<User> modelList, Context context) {
        userList = modelList;
        mContext = context;
    }
    ...
    @NonNull
    @Override
    public LeaderboardApapter_7.MyViewHolderLeaderboard onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        // Inflate out card list item
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_leaderboard_7, parent, false);
        // Return a new view holder
        return new LeaderboardApapter_7.MyViewHolderLeaderboard(view);
    }

    @Override
    public void onBindViewHolder(@NonNull LeaderboardApapter_7.MyViewHolderLeaderboard holder, int position) {
