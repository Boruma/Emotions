...
import com.example.Emotions.Adapters.LeaderboardApapter_7;
...
public class leaderboardWeekFragment extends Fragment {
    private RecyclerView recyclerView;
    private LeaderboardApapter_7 mAdapter;
    ...
    public leaderboardWeekFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_leaderboard_week, container, false);
        GetAllUsers(view);

        recyclerView = view.findViewById(R.id.leaderboard_recycler_view_7);
    ...
    public void GetAllUsers(View view){
        ...
        //Zuhause
      final String urlGet = getString(R.string.ServerIP)+ "/Bachelorarbeit/public/api/auth/points/leaderboard/7";
        ...
        JsonArrayRequest getRequest = new JsonArrayRequest(Request.Method.GET, urlGet, null,
                new Response.Listener<JSONArray>()
                {
                    ...
                    public void onResponse(JSONArray response) {
                        userlistReq.clear();
                        if(userlistReq.isEmpty()){
                            String json = response.toString();
                         //   Log.d("json-response-week", response.toString());
                            ...
                            Log.d("week", userlistReq.toString());
                            Comparator<User> compareByPoints = (User o1, User o2) -> o2.getPoints_7() - o1.getPoints_7();
                            userlistReq.sort(compareByPoints);
                            mAdapter = new LeaderboardApapter_7(userlistReq, getContext());
