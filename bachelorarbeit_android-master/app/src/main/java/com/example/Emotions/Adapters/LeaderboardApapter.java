...
public class LeaderboardApapter extends RecyclerView.Adapter<LeaderboardApapter.MyViewHolderLeaderboard>{
    ...
    public LeaderboardApapter(List<User> modelList, Context context) {
        userList = modelList;
        mContext = context;
    }
    ...
    @NonNull
    @Override
    public LeaderboardApapter.MyViewHolderLeaderboard onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        // Inflate out card list item
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_leaderboard, parent, false);
        // Return a new view holder
        return new LeaderboardApapter.MyViewHolderLeaderboard(view);
    }

    @Override
    public void onBindViewHolder(@NonNull LeaderboardApapter.MyViewHolderLeaderboard holder, int position) {
